							...
							<table class="table table-bordered table-hover">
								...
								<tbody>	
									<?php if (!empty($result)) 
									{
										...
										{ ?>
											<tr>								
												<td><a href="admin_attendance_report.php?user=<?php echo $rows['user_name']; ?>&usid=<?php echo $rows['id']; ?>&shid=<?php echo $txtshop; ?>&sdate=<?php echo $stdate;?>&edate=<?php echo $eddate;?>" style='font-size:14px; font-weight:bold; color:#DE5050; text-decoration:underline;'><?php echo $rows['user_name']; ?></a></td>									
