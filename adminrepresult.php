...
<?php
	...
	$imodelsql = "";
	if (!empty($txtcst)) {
		//$imodelsql = " AND customer_name like '%$txtcst%'";	
	...
	$swhere= "1=1 $imodelsql $inetworksql";
	//echo $swhere;
				...
				<tbody>
					...
					?>	
							...
							*/	
							...
							<td data-title="Invoice"><?php echo $invno;?></td>
...
<script type="text/javascript">
	...
	function snextRecords() {
		...
		$.post("adminrepresult.php",{spageNum:currentPage,txtcon:stxtcon,txtcst:stxtcst},function(data){
			$('#represult').html(data);
		});
	...
	function sjumpToRecords(cpage) {
		...
		$.post("adminrepresult.php",{spageNum:cpage,txtcon:stxtcon,txtcst:stxtcst},function(data){
			//alert(data);
			$('#represult').html(data);
		});
	}
	...
	function DivRefreshrj() {
		...
		$.post("adminrepresult.php",{cpageNum:pcurrentPage},function(data){
			$('#adminrepresult').html(data);
		});
    }
