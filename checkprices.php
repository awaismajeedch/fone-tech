		...
		<div class="container">					
			<div class="row-fluid distance_1" style="margin-top:30px;">	
				<div class="row-fluid">
					<div class="span12 discover">		
						...
						<div class="span5">	
							<div class="control-group">
								...
								<div class="controls">													
									<input  type="text" name="make" id="make" autocomplete="off" data-provide="typeahead"  class="input-large" tabindex="1" >
								</div>
							</div>																											
							<div class="control-group">							
								<label class="control-label" >Part Name: </label>
								<div class="controls">
									<input  type="text" name="part" id="part" autocomplete="off" data-provide="typeahead" class="input-large" tabindex="3">
								</div>
							</div>										
						</div>
						<div class="span5">														
							<div class="control-group">							
								...
								<div class="controls">												
									<input  type="text"  name="model" id="model" autocomplete="off" data-provide="typeahead" class="input-large" tabindex="2" />																								
								</div>
							</div>														
							<div class="control-group">							
					...
					<div>
						<div id="checkpriceslist">
							<?php
								include_once($pathaj."checkprices_list.php");
							?>	
						</div>												
					</div> 			
				</div>  
...
<script type="text/javascript">		
	...
	function validatesForm() {
		...
		var serializedData = $('#searchcform').serialize();				
			$.post("checkprices_list.php",serializedData,function(data){
