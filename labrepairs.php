...
<!-- Include Header  -->
<?php
	include_once($path ."labheader.php"); 
			...
			<div class="row-fluid distance_1" style="margin-top:30px;">	
				<div class="row-fluid">
					...
					<div>
						<div id="statuscount">
							<?php
								include_once($pathaj."status_count_lab.php");
							?>	
						</div>	
					</div>
				
					<div>
						<div id="labrepairslist">
							<?php
								include_once($pathaj."labrepairs_list.php");
							?>	
						</div>												
					</div> 			
				</div>  
...
<script type="text/javascript">		
	...
	function validatesForm() {
		...
		var serializedData = $('#searchrform').serialize();				
			$.post("labrepairs_list.php",serializedData,function(data){
				$('#labrepairslist').html(data);
			});
			$.post("status_count_lab.php",serializedData,function(data){
