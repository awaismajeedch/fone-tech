											...
											foreach ($datar as $row) {								
													...
													?>	
														<tr>
															<?php $rfid = $row['id'];											
															?>
															<td data-title="Shop Name"><a href="shopuser_attendance.php?shid=<?php echo $row['id'];?>&shname=<?php echo $row['name'];?>"  style="font-size:14px; font-weight:bold; color:#DE5050; text-decoration:underline;" ><?php echo $row['name'];?></a></td>																																									
