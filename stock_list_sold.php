...
<?php
    ...
    $two_months = date('Y-m-1 H:i:s', strtotime("$current_date -0 month"));
    $orderby = " ORDER BY created_at DESC";
	$where= "shop_id = $shid  AND date_entered >= '$two_months' ";
	...
	$statusIn = $mysqli->query("SELECT count(id) as stockCount from sale where shop_id = $shid AND date_entered >= '$two_months' ")->fetch_object()->stockCount;
?>
	<?php
		$bit = 0;
	...
	<div class="span12">
		<div class="span4"></div>
		<div class="span6"  style="font-size:18px; font-weight:bold; color:#000000;margin-left:90px;">Sold Stock:&nbsp;&nbsp; <?php echo $statusIn;?> </div>
