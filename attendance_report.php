...
<div class="row-fluid ">				
	...
	<div id="printdiv">
		...
		<div class="container">
			<div class="span12">
				<h2 class="text-center">Attendance of  <?php echo $usfname; ?> from  <?php echo $stdate; ?> to <?php echo $eddate; ?>  </h2>			
...
<script>
	...
	function search() {
		...
		//document.getElementById('searchrform').action = "attendance_report.php?user="+tusname+"&sdate="+tsdate+"&edate="+tedate;
		document.getElementById('searchrform').action = "attendance_report.php?user="+tusname+"&usid="+tusid+"&shid="+tshid+"&sdate="+tsdate+"&edate="+tedate;		
		document.getElementById('searchrform').submit();
		//var str = "attendance_report.php?user="+tusname+"&sdate="+tsdate+"&edate="+tedate;		
		//alert(str);
		//window.location = str;		
	}
